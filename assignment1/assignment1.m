...
%
% Answer: The clear all command clears all variables, and information
% stored and saved prior to that from the workspace area. 
%
...
%
% Answer: std(x), This is a function to find the standard deviation from a
% variable comprised of numbers.
%
...
%
% Answer: The two major kinds of loops of are "for" and "while" loops.
% "For" loops have a set quanitiy of times you want the loop to occur, and
% while loops occur indefiently unitl a condition is not true anymore.
% 
...
%
% Answer: NaN stands for not a number, in an instance where number value
% would be blank or missing or incokmplete for a matrix.
%
...
decimalVariable = 9.6
newDecimalVariable = int32(decimalVariable)
...
% The code takes the values from both variables base1 and bas2 and adds
% them together. Then the formula divdes the added bases by two, and then
% multiplies by the value from the height. This is the equation for the
% area of a trapazoid. 
